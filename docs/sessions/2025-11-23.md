...
**Code Quality:**
- Fixed lint: 25 errors → 0 errors (ignored legacy scripts in eslint config)
...
- [ ] Add API route tests with MSW (Mock Service Worker)
- [ ] Wire up `env.ts` validation in a server component or API route
