...
import { MovieStructuredData } from '@/components/movie/MovieStructuredData';
...
export default function MovieDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  }, [movieId, fetchMovieDetails, fetchTags]);
  ...
  }, [movie?.tmdb_id, fetchWatchProviders]);
  ...
  const handleBack = () => {
    ...
    switch (fromContext) {
      ...
      case 'oscars':
        ...
        break;
      default:
        // If no context or unknown, try to go back in history
  ...
  const tabs = [
    ...
    { id: 'personal' as TabType, label: 'Edit', icon: Edit3 },
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <p className="text-white/60 text-xl mb-4">Movie not found</p>
          <button
            onClick={handleBack}
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Main Content */}
      <div className="pt-32 lg:pt-36 pb-8">
                      ...
                      <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <div className="text-xs text-white/60 mb-1">My Rating</div>
                              {userMovie.personal_rating ? (
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-white font-bold">{userMovie.personal_rating}/10</span>
                                </div>
                              ) : (
                                <span className="text-white/40 text-sm">Not rated</span>
                              )}
                            </div>
                            <div>
                              <div className="text-xs text-white/60 mb-1">Watch Date</div>
                              <div className="flex items-center gap-1 text-white">
                                <Calendar className="w-4 h-4" />
                                <span>{formatDate(userMovie.date_watched)}</span>
                              </div>
                            </div>
                          </div>

                          {/* Watch Location */}
                          {userMovie.watch_location && (
                            <div>
                              <div className="text-xs text-white/60 mb-1">Watch Location</div>
                              <div className="flex items-center gap-1 text-white">
                                <MapPin className="w-4 h-4" />
                                <span>{userMovie.watch_location}</span>
                              </div>
                            </div>
                          )}
                          ...
                          {Array.isArray(userMovie.buddy_watched_with) && userMovie.buddy_watched_with.length > 0 && (
                            <div>
                              <div className="text-xs text-white/60 mb-2">Watched With</div>
                              <div className="flex flex-wrap gap-2">
                                {userMovie.buddy_watched_with.map((buddy) => (
                                  <span
                                    key={buddy}
                                    className="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm flex items-center gap-1 border border-green-500/40"
                                  >
                          ...
                          {/* Tags */}
                          {movie.movie_tags && movie.movie_tags.length > 0 && (
                            <div>
                          ...
                          {userMovie.notes && (
                            <div>
                              <div className="text-xs text-white/60 mb-2">My Notes</div>
                              <p className="text-white/80 text-sm leading-relaxed whitespace-pre-wrap bg-black/20 rounded-lg p-3">
                                {userMovie.notes}
                              </p>
                            </div>
                          )}
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6">
                    <div className="mb-6">
                      ...
                      <p className="text-sm text-white/60">
                        Your personal data is displayed on the Overview tab. Use this tab to update your tracking information.
                      </p>
                    </div>
                    <div className="space-y-4">
                      {/* Watch Date */}
                      ...
                      {isEditing ? (
                        <div className="space-y-3">
                          ...
                          <div className="relative">
                            ...
                            />
                            {showTagDropdown && (
                              <div className="absolute top-full mt-1 w-full bg-black/90 border border-white/20 rounded-lg max-h-40 overflow-y-auto z-10">
                                {availableTags
                                  .filter(tag =>
